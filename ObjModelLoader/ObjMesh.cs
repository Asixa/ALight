...
namespace ObjModelLoader
{
    public class ObjMesh
    {
        ...
        /// UV坐标列表
        /// </summary>
        private List<ObjVector3> uvArrayList;

        /// <summary>
        /// 法线列表
        /// </summary>
        private List<ObjVector3> normalArrayList;

        /// <summary>
        /// 顶点列表
        /// </summary>
        private List<ObjVector3> vertexArrayList;

        /// <summary>
        /// 面相关的顶点索引、法线索引、UV索引列表
        /// </summary>
        private List<ObjVector3> faceVertexNormalUV;

        /// <summary>
        /// UV坐标数组
        /// </summary>
        public ObjVector2[] UVArray;

        /// <summary>
        /// 法线数组
        /// </summary>
        public ObjVector3[] NormalArray;

        /// <summary>
        /// 顶点数组
        /// </summary>
        public ObjVector3[] VertexArray;
        ...
        {
            //初始化列表
            this.uvArrayList = new List<ObjVector3>();
            this.normalArrayList = new List<ObjVector3>();
            this.vertexArrayList = new List<ObjVector3>();
            this.faceVertexNormalUV = new List<ObjVector3>();
        }
        ...
        public ObjMesh LoadFromObj(string objText)
        {
            ...
            foreach (string line in allLines)
            {
                ...
                switch (chars[0])
                {
                    case "v":
                        //处理顶点
                        this.vertexArrayList.Add(new ObjVector3(
                    ...
                    case "vn":
                        //处理法线
                        this.normalArrayList.Add(new ObjVector3(
                            ConvertToFloat(chars[1]),
                            ConvertToFloat(chars[2]),
                            ConvertToFloat(chars[3]))
                        );
                    ...
                    case "vt":
                        //处理UV
                        this.uvArrayList.Add(new ObjVector3(
                            ConvertToFloat(chars[1]),
                            ConvertToFloat(chars[2]))
                        );
                        break;
    ...
    public class ObjVector3
    {
        public float x, y, z;
        public static ObjVector3 zero=new ObjVector3(0,0,0);
        public ObjVector3(float a, float b, float c)
        {
            x = a;
            y = b;
            z = c;
        }
        public ObjVector3(float a, float b )
        {
            x = a;
            y = b;
            z = 0;
    ...
    public class ObjVector2
    {
        public float x, y;

        public ObjVector2(float a, float b)
        {
            x = a;
            y = b;
        }
